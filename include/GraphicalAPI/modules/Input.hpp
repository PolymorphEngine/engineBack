...
/////////////////////////////// METHODS /////////////////////////////////
        public:
            ...
            static void setExitKey(
                    KeyCode);                                               // Set a custom key to exit program (default is ESC)
            static bool isMouseButtonPressed(
                    MouseButton button);                                  // Check if a mouse button has been pressed once
            static bool isMouseButtonDown(
                    MouseButton button);                                     // Check if a mouse button is being pressed
            static bool isMouseButtonReleased(
                    MouseButton button);                                 // Check if a mouse button has been released once
            static bool isMouseButtonUp(MouseButton button);

            static Vector2 getMousePosition(void);

            static void setMousePosition(
                    Vector2 position);                                    // Set mouse position XY
            static void setMouseOffset(
                    Vector2 offset);                          // Set mouse offset
            static void setMouseScale(
                    Vector2 scale);                         // Set mouse scaling
            static float getMouseWheelMove(
                    void);                                      // Get mouse wheel movement Y
            ...
            static bool isCursorHidden(
                    void);                                              // Check if cursor is not visible
