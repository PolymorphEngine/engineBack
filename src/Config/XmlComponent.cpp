...
//template<>
//void Polymorph::Config::XmlComponent::_setPrimitiveProperty(std::shared_ptr<XmlNode> &data, int &toSet, Logger::severity level)
//{
//    Polymorph::Config::XmlComponent::_setPropertyFromAttr("value", toSet, *data, level);
//}
//template<>
//void Polymorph::Config::XmlComponent::_setPrimitiveProperty(std::shared_ptr<XmlNode> &data, float &toSet, Logger::severity level)
//{
//    Polymorph::Config::XmlComponent::_setPropertyFromAttr("value", toSet, *data, level);
//}
//template<>
//void Polymorph::Config::XmlComponent::_setPrimitiveProperty(std::shared_ptr<XmlNode> &data, bool &toSet, Logger::severity level)
//{
//    Polymorph::Config::XmlComponent::_setPropertyFromAttr("value", toSet, *data, level);
//}
//template<>
//void Polymorph::Config::XmlComponent::_setPrimitiveProperty(std::shared_ptr<XmlNode> &data, std::string &toSet, Logger::severity level)
//{
//    Polymorph::Config::XmlComponent::_setPropertyFromAttr("value", toSet, *data, level);
//}

//template<>
//void Polymorph::Config::XmlComponent::_setRefProperty(std::shared_ptr<XmlNode> &refProp, GameObject &toSet, Logger::severity level)
//{
//    if (refProp == nullptr)
//        return;
//    try {
